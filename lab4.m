...
pozymiai_tinklo_mokymui = pozymiai_raidems_atpazinti('raides_apmokymui.png',4);
% Atpaþintuvo kûrimas
...
disp(atsakymas)
figure(8), text(0.03,0.2,atsakymas,'FontSize',38)
%%
close all
% Extract features of the test image
pavadinimas = 'zodis1.png';
...
% pateikime rezultatà komandiniame lange
disp(atsakymas)
figure(12), text(0.1,0.5,atsakymas,'FontSize',38), axis off
