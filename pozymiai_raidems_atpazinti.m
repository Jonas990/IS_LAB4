...
disp('apmokymo raidziu skaicius')
disp(Skaicius)
...
figure(6),
for k = 1:Skaicius
   subplot(pvz_eiluciu_sk,round(raidziu_sk)-10,k), imshow(objektai{k})
end
...
figure(7),
for k = 1:Skaicius
   subplot(pvz_eiluciu_sk,round(raidziu_sk),k), imshow(objektai{k})
end
%
